...
pen1 = 0
pen2 = 0
MODE = 0 # 0-Image mode   1-Function Mode
...
def main():
	...
	if(MODE == 0):
		...
		#MODE = 1 represents function mode and hence calls function_mode function to generate x, y and theta goals
		x_g, y_g = [], []
	...
	while not rospy.is_shutdown():
		...
		if(goal_num == len(x_goals[contour_num]) - 1):
			...
			#Iterarting each goal to next goal.
			goal_num += 1
