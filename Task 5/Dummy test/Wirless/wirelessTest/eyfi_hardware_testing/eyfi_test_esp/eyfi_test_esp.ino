...
// WiFi credentials
const char* ssid = "Test";                    //Enter your wifi hotspot ssid
const char* password =  "12345678";               //Enter your wifi hotspot password
const uint16_t port = 8002;
const char * host = "192.168.140.167";                   //Enter the ip address of your laptop after connecting it to wifi hotspot
